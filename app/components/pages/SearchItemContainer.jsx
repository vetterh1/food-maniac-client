...
class SearchItemContainer extends React.Component {
  ...
  FindMarks() {
    ...
    return new Promise((resolve, reject) => {
      ...
      fetch(`${process.env.GATEWAY}/api/markAggregates/itemId/${item}/maxDistance/${this.values.distance}/lat/${this.props.coordinates.latitude}/lng/${this.props.coordinates.longitude}`)
      .then((response) => {
